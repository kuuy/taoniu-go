...
import (
	...
	plansRepositories "taoniu.local/cryptos/repositories/binance/futures/plans"
...
func (r *ScalpingRepository) Symbols() *futuresRepositories.SymbolsRepository {
...
func (r *ScalpingRepository) Orders() *futuresRepositories.OrdersRepository {
...
func (r *ScalpingRepository) Account() *futuresRepositories.AccountRepository {
