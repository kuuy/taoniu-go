...
func (r *MinutelyRepository) Count(conditions map[string]interface{}) int64 {
  var total int64
...
func (r *MinutelyRepository) Listings(conditions map[string]interface{}, current int, pageSize int) []*models.Plan {
...
func (r *MinutelyRepository) Flush() error {
...
func (r *MinutelyRepository) Fix() error {
  var plans []*models.Plan
  r.Db.Select([]string{
    "id",
    "symbol",
...
func (r *MinutelyRepository) Create(signals map[string]interface{}, side int) error {
...
func (r *MinutelyRepository) Signals() (map[string]interface{}, map[string]interface{}) {
...
func (r *MinutelyRepository) Filter() (*models.Plan, error) {
  now := time.Now()
  duration := time.Hour*time.Duration(8-now.Hour()) - time.Minute*time.Duration(now.Minute()) - time.Second*time.Duration(now.Second())
  timestamp := now.Add(duration).Unix()
