...
const (
  ...
  ASYNQ_JOBS_INDICATORS_VOLUME                 = "binance:spot:indicators:volume"
  ASYNQ_JOBS_INDICATORS_ANDEAN_OSCILLATOR      = "binance:spot:indicators:andean_oscillator"
  ASYNQ_JOBS_INDICATORS_AHR999                 = "binance:spot:indicators:ahr999"
  ...
  LOCKS_PLANS_FLUSH                            = "locks:binance:spot:plans:%s:flush"
  ...
  LOCKS_TASKS_KLINES_FLUSH                     = "locks:binance:spot:tasks:klines:flush:%v:%v"
  LOCKS_TASKS_KLINES_FIX                       = "locks:binance:spot:tasks:klines:fix:%v:%v"
