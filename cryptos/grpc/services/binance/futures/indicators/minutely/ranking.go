...
import (
  ...
  "gorm.io/gorm"
  pb "taoniu.local/cryptos/grpc/binance/futures/indicators/minutely/ranking"
  futuresRepositories "taoniu.local/cryptos/repositories/binance/futures"
  repositories "taoniu.local/cryptos/repositories/binance/futures/indicators/minutely"
)
