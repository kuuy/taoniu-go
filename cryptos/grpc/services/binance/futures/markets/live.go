...
import (
  ...
  pb "taoniu.local/cryptos/grpc/binance/futures/markets/live"
  futuresRepositories "taoniu.local/cryptos/repositories/binance/futures"
  repositories "taoniu.local/cryptos/repositories/binance/futures/markets"
)
...
func NewLive(
  ...
  repository.TickersRepository = &futuresRepositories.TickersRepository{
    Rdb: rdb,
    Ctx: ctx,
  }
  return &Live{
