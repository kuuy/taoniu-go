...
func (c *gridsClient) Pagenate(ctx context.Context, in *PagenateRequest, opts ...grpc.CallOption) (*PagenateReply, error) {
	...
	err := c.cc.Invoke(ctx, "/taoniu.local.cryptos.grpc.binance.spot.margin.cross.tradings.triggers.grids.Grids/Pagenate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Grids_Pagenate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/taoniu.local.cryptos.grpc.binance.spot.margin.cross.tradings.triggers.grids.Grids/Pagenate",
	}
...
var Grids_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "taoniu.local.cryptos.grpc.binance.spot.margin.cross.tradings.triggers.grids.Grids",
	...
	Metadata: "binance/spot/margin/cross/tradings/triggers/grids/grids.proto",
}
