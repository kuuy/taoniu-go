...
func (c *liveClient) Pagenate(ctx context.Context, in *PagenateRequest, opts ...grpc.CallOption) (*PagenateReply, error) {
	...
	err := c.cc.Invoke(ctx, "/taoniu.local.cryptos.grpc.binance.futures.markets.live.Live/Pagenate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Live_Pagenate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/taoniu.local.cryptos.grpc.binance.futures.markets.live.Live/Pagenate",
	}
...
var Live_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "taoniu.local.cryptos.grpc.binance.futures.markets.live.Live",
	...
	Metadata: "binance/futures/markets/live/live.proto",
}
