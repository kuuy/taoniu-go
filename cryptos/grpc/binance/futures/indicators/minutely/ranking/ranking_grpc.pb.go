...
func (c *rankingClient) Pagenate(ctx context.Context, in *PagenateRequest, opts ...grpc.CallOption) (*PagenateReply, error) {
	...
	err := c.cc.Invoke(ctx, "/taoniu.local.cryptos.grpc.binance.futures.indicators.minutely.ranking.Ranking/Pagenate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Ranking_Pagenate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/taoniu.local.cryptos.grpc.binance.futures.indicators.minutely.ranking.Ranking/Pagenate",
	}
