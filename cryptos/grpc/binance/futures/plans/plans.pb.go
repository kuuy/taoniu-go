...
func (x *PaginateReply) GetData() []*PlanInfo {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_binance_futures_plans_plans_proto_goTypes = []interface{}{
	...
	(*PaginateRequest)(nil),     // 1: taoniu.local.cryptos.grpc.binance.futures.plans.PaginateRequest
	(*PaginateReply)(nil),       // 2: taoniu.local.cryptos.grpc.binance.futures.plans.PaginateReply
...
var file_binance_futures_plans_plans_proto_depIdxs = []int32{
	...
	0, // 1: taoniu.local.cryptos.grpc.binance.futures.plans.PaginateReply.data:type_name -> taoniu.local.cryptos.grpc.binance.futures.plans.PlanInfo
	1, // 2: taoniu.local.cryptos.grpc.binance.futures.plans.Plans.Paginate:input_type -> taoniu.local.cryptos.grpc.binance.futures.plans.PaginateRequest
	2, // 3: taoniu.local.cryptos.grpc.binance.futures.plans.Plans.Paginate:output_type -> taoniu.local.cryptos.grpc.binance.futures.plans.PaginateReply
