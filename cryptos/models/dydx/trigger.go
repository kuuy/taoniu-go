...
type Trigger struct {
  ...
  Symbol      string    `gorm:"size:20;not null;index:idx_dydx_triggers_symbol_status"`
  ...
  Status      int       `gorm:"type:integer;not null;index;index:idx_dydx_triggers_symbol_status"`
