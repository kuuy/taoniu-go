...
type Scalping struct {
  ...
  Side           int            `gorm:"not null;uniqueIndex:unq_dydx_analysis_tradings_scalping"`
  Day            datatypes.Date `gorm:"not null;uniqueIndex:unq_dydx_analysis_tradings_scalping"`
...
func (m *Scalping) TableName() string {
  return "dydx_analysis_tradings_scalping"
}
