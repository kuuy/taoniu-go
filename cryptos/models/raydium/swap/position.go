...
type Position struct {
  ...
  Symbol        string    `gorm:"size:20;not null;index:idx_raydium_swap_positions_symbol_status"`
  ...
  Status        int       `gorm:"type:integer;not null;index:idx_raydium_swap_positions_symbol_status"`
