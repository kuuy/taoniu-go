...
type Trigger struct {
  ...
  TriggerID    string    `gorm:"size:20;index:idx_binance_futures_tradings_triggers"`
  ...
  Status       int       `gorm:"type:integer;not null;index;index:idx_binance_futures_tradings_triggers"`
