...
type Ant struct {
  ...
  Mode      int       `gorm:"type:integer;not null;index:idx_binance_futures_tradings_gambling_ant"`
  ...
  Status    int       `gorm:"type:integer;not null;index;index:idx_binance_futures_tradings_gambling_ant"`
