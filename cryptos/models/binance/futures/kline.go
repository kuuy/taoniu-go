...
type Kline struct {
  ...
  Interval  string    `gorm:"size:3;not null;uniqueIndex:unq_binance_futures_klines_symbol_interval_timestamp;index:idx_binance_futures_klines_interval_timestamp"`
