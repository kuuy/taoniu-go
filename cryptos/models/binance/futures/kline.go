...
type Kline struct {
  ...
  Interval  string    `gorm:"size:2;not null;uniqueIndex:unq_binance_futures_klines_symbol_interval_timestamp;index:idx_binance_futures_klines_interval_timestamp"`
  ...
  Timestamp int64     `gorm:"not null;uniqueIndex:unq_binance_futures_klines_symbol_interval_timestamp;index:idx_binance_futures_klines_interval_timestamp"`
