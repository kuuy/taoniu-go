...
type Scalping struct {
  ...
  Symbol      string    `gorm:"size:20;not null;index:idx_binance_margin_cross_scalping_symbol_status"`
  ...
  Status      int       `gorm:"type:integer;not null;index;index:idx_binance_margin_cross_scalping_symbol_status"`
...
func (m *Scalping) TableName() string {
  return "binance_margin_cross_scalping"
}
...
func (m *ScalpingPlan) TableName() string {
  return "binance_margin_cross_scalping_plans"
}
