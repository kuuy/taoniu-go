...
type Trigger struct {
  ...
  Side           int            `gorm:"not null;uniqueIndex:unq_binance_margin_cross_analysis_tradings_trigger"`
  Day            datatypes.Date `gorm:"not null;uniqueIndex:unq_binance_margin_cross_analysis_tradings_trigger"`
