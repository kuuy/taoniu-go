...
type Scalping struct {
  ...
  ScalpingId   string    `gorm:"size:20;index:idx_binance_margin_isolated_tradings_scalping"`
  ...
  Status       int       `gorm:"type:integer;not null;index;index:idx_binance_margin_isolated_tradings_scalping"`
...
func (m *Scalping) TableName() string {
  return "binance_margin_isolated_tradings_scalping"
}
