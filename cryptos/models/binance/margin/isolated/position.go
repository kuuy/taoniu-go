...
type Position struct {
  ...
  Symbol        string    `gorm:"size:20;not null;index:idx_binance_margin_isolated_positions"`
  ...
  Status        int       `gorm:"type:integer;not null;index:idx_binance_margin_isolated_positions"`
...
func (m *Position) TableName() string {
  return "binance_margin_isolated_positions"
}
