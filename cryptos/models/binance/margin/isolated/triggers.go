...
type Trigger struct {
  ...
  Symbol      string    `gorm:"size:20;not null;index:idx_binance_margin_isolated_triggers_symbol_status"`
  ...
  Status      int       `gorm:"type:integer;not null;index;index:idx_binance_margin_isolated_triggers_symbol_status"`
...
func (m *Trigger) TableName() string {
  return "binance_margin_isolated_triggers"
}
