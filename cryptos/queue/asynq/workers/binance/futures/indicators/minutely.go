...
func (h *Minutely) Register(mux *asynq.ServeMux) error {
  mux.HandleFunc("binance:futures:indicators:1m:pivot", h.Pivot)
  mux.HandleFunc("binance:futures:indicators:1m:atr", h.Atr)
  mux.HandleFunc("binance:futures:indicators:1m:zlema", h.Zlema)
  mux.HandleFunc("binance:futures:indicators:1m:hazlema", h.HaZlema)
  mux.HandleFunc("binance:futures:indicators:1m:kdj", h.Kdj)
  mux.HandleFunc("binance:futures:indicators:1m:bbands", h.BBands)
  mux.HandleFunc("binance:futures:indicators:1m:volume_profile", h.VolumeProfile)
  return nil
}
